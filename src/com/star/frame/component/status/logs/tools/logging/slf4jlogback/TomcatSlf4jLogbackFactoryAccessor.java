...
import com.star.frame.component.status.logs.tools.logging.DefaultAccessor;
 ...
 * 
 * <p>
 * All TomcatSlf4jLogback classes are loaded via the given class loader and not via psi-probe's own class loader. For
 * this reasons, all methods on TomcatSlf4jLogback objects are invoked via reflection.
 * </p>
 * <p>
...
public class TomcatSlf4jLogbackFactoryAccessor extends DefaultAccessor {
    ...
    public TomcatSlf4jLogbackLoggerAccessor getRootLogger() {
        /*
         * TomcatSlf4jLogback has no dedicated getRootLogger() method, so we simply access the root logger by its
         * well-defined name.
         */
     ...
     * 
     * @return a list of {@link TomcatSlf4jLogbackAppenderAccessor}s representing all appenders that are in use
     */
